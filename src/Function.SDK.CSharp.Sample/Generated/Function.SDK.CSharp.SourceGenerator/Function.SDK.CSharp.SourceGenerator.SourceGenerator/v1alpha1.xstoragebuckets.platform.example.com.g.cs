...
{
    public V1alpha1XStorageBucketSpecParameters()
    {
    }
    ...
    public V1alpha1XStorageBucketSpecParametersAclEnum Acl { get; set; }

    /// <summary>Geographic location where the storage bucket will be created</summary>
    [JsonPropertyName("location")]
    [JsonConverter(typeof(JsonStringEnumConverter<V1alpha1XStorageBucketSpecParametersLocationEnum>))]
    public V1alpha1XStorageBucketSpecParametersLocationEnum Location { get; set; }
...
{
    public V1alpha1XStorageBucketSpecCrossplaneCompositionRef()
    {
    }
...
{
    public V1alpha1XStorageBucketSpecCrossplaneCompositionRevisionRef()
    {
    }
...
{
    public V1alpha1XStorageBucketSpecCrossplaneCompositionRevisionSelector()
    {
    }
...
{
    public V1alpha1XStorageBucketSpecCrossplaneCompositionSelector()
    {
    }
...
{
    public V1alpha1XStorageBucketSpecCrossplaneResourceRefs()
    {
    }
...
{
    public V1alpha1XStorageBucketSpecCrossplane()
    {
    }
...
{
    public V1alpha1XStorageBucketSpec()
    {
    }

    /// <summary></summary>
    [JsonPropertyName("parameters")]
    public V1alpha1XStorageBucketSpecParameters Parameters { get; set; }
...
{
    public V1alpha1XStorageBucketStatusConditions()
    {
    }
...
{
    public V1alpha1XStorageBucketStatus()
    {
    }
...
public partial class V1alpha1XStorageBucket : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1XStorageBucketSpec>, IStatus<V1alpha1XStorageBucketStatus>
{
    ...
    public V1alpha1XStorageBucketSpec Spec { get; set; }
